...
class InterfaceController: WKInterfaceController {
    ...
    override func awake(withContext context: Any?) {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(resetViewForSnapshot), name: NSNotification.Name("resetViewForSnapshot"), object: nil)
    }
    
    // MARK: - Snapshot
    func resetViewForSnapshot() {
