...
- (void)presentAlert
{
    ...
    [self presentAlertControllerWithTitle:nil message:@"Top 10 list currently unavailable" preferredStyle:WKAlertControllerStyleAlert actions:@[cancelAction, retryAction]];
}
